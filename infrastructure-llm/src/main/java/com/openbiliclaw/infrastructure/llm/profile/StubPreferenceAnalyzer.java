/**
 * file: StubPreferenceAnalyzer.java
 * author: daiyinbao
 * date: 2026-08-06
 */
...
public class StubPreferenceAnalyzer implements PreferenceAnalyzer {
    ...
    public PreferenceProfile analyze(List<UserEvent> events) {
        ...
        if (interestMap.isEmpty()) {
          ...
          double depthPreference = clamp01(0.40 + favoriteCount * 0.15 + likeCount * 0.08);
